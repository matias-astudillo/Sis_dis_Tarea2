...
class OrderManagementStub(object):
    ...
    def __init__(self, channel):
        ...
        self.CreateOrder = channel.unary_unary(
                '/order_management.OrderManagement/CreateOrder',
        ...
        self.GetOrderStatus = channel.unary_unary(
                '/order_management.OrderManagement/GetOrderStatus',
                request_serializer=order__management__pb2.OrderStatusRequest.SerializeToString,
                response_deserializer=order__management__pb2.OrderStatusResponse.FromString,
                _registered_method=True)
...
def add_OrderManagementServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'GetOrderStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=order__management__pb2.OrderStatusRequest.FromString,
                    response_serializer=order__management__pb2.OrderStatusResponse.SerializeToString,
            ),
    }
...
class OrderManagement(object):
    ...
    def GetOrderStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/order_management.OrderManagement/GetOrderStatus',
            order__management__pb2.OrderStatusRequest.SerializeToString,
            order__management__pb2.OrderStatusResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
